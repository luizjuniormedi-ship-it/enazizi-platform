...
const AIMentor = () => {
  const [messages, setMessages] = useState<Msg[]>([
    { role: "assistant", content: "Olá! Sou o MentorPF, seu mentor IA especializado no concurso de Delegado da Polícia Federal. Como posso ajudá-lo hoje? 🚀" },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (!resp.ok) {
        ...
        const errorMsg = errData.error || "Erro ao conectar com o mentor IA";
      ...
      console.error(e);
      toast({ title: "Erro", description: "Falha ao conectar com o mentor IA.", variant: "destructive" });
    } finally {
      setIsLoading(false);
    }
  };
