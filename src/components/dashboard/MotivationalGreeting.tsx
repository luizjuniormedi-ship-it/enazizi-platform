...
const PHRASES: Record<Mood, string[]> = {
  champion: [
    ...
    "⭐ Performance de elite! {accuracy}% de acerto é nível R1 já aprovado.",
    "🧬 Seu DNA tá expressando gene de aprovação. Mantém essa epigenética!",
    "🥇 {streak} dias na sequência — mais disciplinado(a) que protocolo de UTI!",
    "🎓 Com esse desempenho, até o preceptor ia te chamar de colega.",
    "💎 Acertando {accuracy}% e com {streak} dias seguidos? Isso é ouro puro!",
    "🏅 Você tá tão preparado(a) que a prova deveria ter medo de você.",
    "🌟 Esse brilho no dashboard é reflexo do seu esforço. Continua!",
    "🦸 Super-herói da medicina: {streak} dias sem falhar. Capa opcional.",
    "🔬 Precisão cirúrgica nos estudos: {accuracy}% de acerto. Impressionante!",
  ],
  good: [
    ...
    "📈 Evolução constante! {streak} dias seguidos mostra comprometimento real.",
    "🌱 Cada dia de estudo é uma semente. Você já tá colhendo resultados!",
    "✨ Tá construindo um conhecimento sólido. Isso ninguém tira de você.",
    "🎯 Foco no alvo! {accuracy}% mostra que o estudo tá rendendo.",
    "🧩 Mais uma peça do quebra-cabeça encaixando. Segue firme!",
    "💪 Consistência é a chave, e você tá com ela no bolso. Bora!",
    "📊 Os números não mentem: você tá evoluindo. Mantém esse ritmo!",
    "🌈 Depois da tempestade vem a aprovação. Tá quase lá!",
  ],
  meh: [
    ...
    "☕ Pega um café e bora! Cada questão resolvida é um passo mais perto da vaga.",
    "🗺️ Sem rumo? Abre o cronograma e escolhe um tema. O primeiro passo é o mais difícil.",
    "🎲 Que tal uma sessão rápida? 30 minutos já faz diferença.",
    "📝 A caneta (ou o teclado) tá te esperando. Só falta você começar!",
    "🔋 Hora de recarregar o modo estudo. Bora resolver umas questões?",
    "🎧 Coloca o fone, abre o MedStudy AI e deixa o mundo lá fora por um tempo.",
    "🏃 O segredo é começar. Depois que começa, o resto flui!",
    "💭 Pensou em estudar? Já é um sinal. Agora transforma pensamento em ação!",
    "🧭 Tá perdido(a)? Normal. Escolhe um tema fraco e ataca ele hoje.",
  ],
  slacking: [
    ...
    "🫣 O dashboard tá triste de te ver assim. Faz pelo menos 15 minutinhos?",
    "🪫 Bateria de estudos em 0%. Conecta no carregador (abre uma questão)!",
    "🐢 Devagar se vai ao longe... mas parado não se vai a lugar nenhum!",
    "📵 Larga o celular e abre o caderno. Seu eu do futuro vai agradecer.",
    "🎭 Drama detectado: você prometeu estudar e não cumpriu. Bora mudar esse roteiro!",
    "🧊 Seus estudos congelaram. Hora de descongelar com uma sessão rápida!",
    "🏳️ Tá rendido(a)? Não pode! Levanta e vai. Nem que seja 10 questões.",
    "💤 Acordou hoje e escolheu não estudar? Ainda dá tempo de mudar essa decisão.",
  ],
  danger: [
    ...
    "⚠️ {days} dias e contando! Cada minuto perdido é um ponto a menos na prova.",
    "🆘 SOS acadêmico! {days} dias restantes e o preparo tá abaixo do ideal. FOCA!",
    "🔥 {days} dias! Se fosse paciente, seu caso seria emergência. Trate com urgência!",
    "⏰ ALERTA VERMELHO: {days} dias. Desliga Netflix, abre o MedStudy AI. AGORA.",
    "💣 Bomba-relógio: {days} dias. Só estudo intensivo salva. Bora?",
    "🩸 Situação crítica: {days} dias, progresso baixo. Prescrição: estudo 24/7.",
    "📢 {days} DIAS! Não é hora de descansar. É hora de revisar tudo que puder!",
    "🧨 {days} dias e tá de bobeira? A concorrência tá estudando AGORA.",
  ],
};
