...
const CTASection = () => (
  <section className="py-24 relative overflow-hidden">
    ...
    <div className="container relative z-10">
      <div className="max-w-3xl mx-auto text-center rounded-3xl border border-primary/20 bg-card/80 backdrop-blur-sm p-10 md:p-16 shadow-[0_0_60px_hsl(var(--primary)/0.08)]">
